...
export const linkQuoteToAdditionnalDataStep = createStep('link-quote-to-author-and-book-on-create', async (input: { quote: TQuoteInput; additionnal_data: TQuoteAdditionnalData }, { container }) => {
