...
export type Product = {
  ...
  sales_channels?: Maybe<Array<Maybe<SalesChannel>>>;
  book_link?: Maybe<LinkProductProductBookModuleBook>;
  book?: Maybe<Book>;
};
...
export type Book = {
  __typename?: 'Book';
  id: Scalars['ID']['output'];
  audioVersionUrl?: Maybe<Scalars['String']['output']>;
  dimensions?: Maybe<Scalars['String']['output']>;
  ebookVersionEbook?: Maybe<Scalars['String']['output']>;
  isbn?: Maybe<Scalars['String']['output']>;
  pagesCount?: Maybe<Scalars['Int']['output']>;
  publishDate?: Maybe<Scalars['String']['output']>;
  publisher?: Maybe<Scalars['String']['output']>;
  raw_publishDate?: Maybe<Scalars['JSON']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
  author_link?: Maybe<LinkBookModuleBookAuthorModuleAuthor>;
  author?: Maybe<Author>;
  language_link?: Maybe<LinkBookModuleBookLanguageModuleLanguage>;
  language?: Maybe<Language>;
  product_link?: Maybe<LinkProductProductBookModuleBook>;
  product?: Maybe<Product>;
  quote_link?: Maybe<LinkQuoteModuleQuoteBookModuleBook>;
  quote?: Maybe<Quote>;
};
...
export type Author = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
  book_link?: Maybe<LinkBookModuleBookAuthorModuleAuthor>;
  book?: Maybe<Book>;
  quote_link?: Maybe<LinkQuoteModuleQuoteAuthorModuleAuthor>;
  quote?: Maybe<Quote>;
};
...
export type Language = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
  book_link?: Maybe<LinkBookModuleBookLanguageModuleLanguage>;
  book?: Maybe<Book>;
};
...
export type Quote = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
  author_link?: Maybe<LinkQuoteModuleQuoteAuthorModuleAuthor>;
  author?: Maybe<Author>;
  book_link?: Maybe<LinkQuoteModuleQuoteBookModuleBook>;
  book?: Maybe<Book>;
};
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    book_author: LinkBookModuleBookAuthorModuleAuthor
    book_language: LinkBookModuleBookLanguageModuleLanguage
    product_book: LinkProductProductBookModuleBook
    quote_author: LinkQuoteModuleQuoteAuthorModuleAuthor
    quote_book: LinkQuoteModuleQuoteBookModuleBook
  }
}